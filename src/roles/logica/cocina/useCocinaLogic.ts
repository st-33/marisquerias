...
import { PedidosRepository, type PedidoItem } from '../../../plataforma/base/_persistencia';
...
import { createModuleLogger } from '../../../plataforma/core/monitoring';
// 🔌 DOGMA V2: Leer datos del store centralizado
import { useCategorias, usePedidos, useProductos, useStore } from '../../../plataforma/core/store';
