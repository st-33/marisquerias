...
import { MesasRepository, PedidosRepository } from '../../../plataforma/base/_persistencia';
...
import { useItemsPedido, usePedido, usePedidos, useProductos } from '../../../plataforma/core/store';
