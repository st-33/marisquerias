...
import { MenuRepository, type Producto } from '../../plataforma/base/_persistencia';
import { InventoryV2Repository } from '../../plataforma/base/_persistencia/inventory.v2.repo';
import type { Categoria } from '../../plataforma/base/_persistencia/menu.repo';
import { SimpleSalesRepo } from '../../plataforma/base/_persistencia/SimpleSalesRepo';
import { getRtdb } from '../../plataforma/core/firebase';
import { SQLiteStorageAdapter } from '../../plataforma/core/offline/storage/SQLiteStorageAdapter';
import { OfflinePrintFallback } from '../../plataforma/core/services/OfflinePrintFallback';
import { DespachadorCola } from '../../plataforma/nucleo/sistema-impresion/cola/DespachadorCola';
import { useStore } from '../../plataforma/core/store';
import { resolverDeviceIdADI } from '../../plataforma/instalacion/vinculacion/generar-device-id-adi';
import { useTenantConfig } from '../../plataforma/providers/TenantConfigProvider';
