...
function OrderListComponent(props: OrderListProps) {
  ...
  const getStatusConfig = useCallback((status: string) => {
    switch (status) {
      case 'en_cocina':
        return { label: 'EN COCINA', color: COLORS.warning, bgColor: COLORS.alpha.warning20, dotColor: COLORS.warning };
      case 'preparando':
        return { label: 'PREPARANDO', color: COLORS.info, bgColor: COLORS.alpha.primary20, dotColor: COLORS.info };
      case 'listo':
        return { label: 'LISTO', color: COLORS.success, bgColor: COLORS.alpha.success20, dotColor: COLORS.success };
      case 'entregado':
        return { label: 'ENTREGADO', color: COLORS.success, bgColor: COLORS.alpha.success20, dotColor: COLORS.success };
      default:
        return { label: 'NUEVO', color: COLORS.text.muted, bgColor: COLORS.alpha.primary10, dotColor: COLORS.text.muted };
    }
  }, [COLORS]);
