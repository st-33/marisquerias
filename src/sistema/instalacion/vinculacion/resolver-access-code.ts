 ...
 *
 * Fuente Contractual Única: `codigo_acceso/{CODIGO}`
 *   - string  -> tenantPath directo (ej: "Marisquerias/mpl")
 *   - object  -> { tenantPath: string, estado?, maxUsos?, usosActuales?, expiraEn?, ... }
 *
 * El tenantPath resuelto debe tener una ruta de negocio válida.
 * Si RTDB no responde o el código no existe, el resolver falla explícitamente.
 */
