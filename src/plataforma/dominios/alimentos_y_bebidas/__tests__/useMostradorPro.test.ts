...
jest.mock('../../../base/_persistencia/SimpleSalesRepo', () => ({
...
jest.mock('../../../base/_persistencia/inventory.v2.repo', () => ({
...
jest.mock('../../../instalacion/vinculacion/generar-device-id-adi', () => ({
...
jest.mock('../../../providers/TenantConfigProvider', () => ({
...
jest.mock('../../../core/services/OfflinePrintFallback', () => ({
...
jest.mock('../../../nucleo/sistema-impresion/cola/DespachadorCola', () => ({
  DespachadorCola: {
